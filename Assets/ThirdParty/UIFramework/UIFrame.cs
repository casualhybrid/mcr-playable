    ...
    public class UIFrame : MonoBehaviour
    {
        ...
        public virtual void Initialize() {
            if (panelLayer == null) {
                ...
                if (panelLayer == null) {
                    UnityEngine.Console.LogError("[UI Frame] UI Frame lacks Panel Layer!");
                }
                else {
            ...
            if (windowLayer == null) {
                ...
                if (panelLayer == null) {
                    UnityEngine.Console.LogError("[UI Frame] UI Frame lacks Window Layer!");
                }
                else {
        ...
        public void ShowPanel(string screenId) {
            RegisterTheScreenIfUnregistered(screenId, panelLayer);
        ...
        public void OpenWindow(string screenId) {
             ...
             RegisterTheScreenIfUnregistered(screenId, windowLayer);
        ...
        private void RegisterTheScreenIfUnregistered<Tscreen> (string screenId, AUILayer<Tscreen> aUILayer) where Tscreen : IUIScreenController
        {
            bool isScreenRegistered = aUILayer.IsScreenRegistered(screenId);

            if (!isScreenRegistered)
            {
             //   UnityEngine.Console.Log($"Screen {screenId} wasn't registered. Registerting it now");
                uiSettings.RegisterThisScreenToTheLayer(screenId);
            }
        }
        ...
        /// </summary>
        /// <param name="screenId">Identifier.</param>
        public void EnableWindow(string screenId) 
        {
            windowLayer.EnableScreen(screenId);
        }
        ...
        /// </summary>
        /// <param name="screenId">Identifier.</param>
        public void DisableWindow(string screenId) 
        {
            windowLayer.DisableScreen(screenId);
        }
        ...
        public void ShowScreen(string screenId) {
            ...
            if (IsScreenRegistered(screenId, out type)) {
                ...
                UnityEngine.Console.LogError(string.Format("Tried to open Screen id {0} but it's not registered as Window or Panel!",
                    screenId));
            }
        }
