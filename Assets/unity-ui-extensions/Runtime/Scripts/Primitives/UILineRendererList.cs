    ...
    public class UILineRendererList : UIPrimitiveBase
	{
        ...
        private void PopulateMesh(VertexHelper vh, List<Vector2> pointsToDraw)
		{
			...
			if (vh.currentVertCount > 64000) {
				UnityEngine.Console.LogError ("Max Verticies size is 64000, current mesh verticies count is [" + vh.currentVertCount + "] - Cannot Draw");
				vh.Clear ();
				return;
			}
		...
		private UIVertex[] CreateLineCap(Vector2 start, Vector2 end, SegmentType type)
		{
			...
			UnityEngine.Console.LogError("Bad SegmentType passed in to CreateLineCap. Must be SegmentType.Start or SegmentType.End");
			return null;
		}
