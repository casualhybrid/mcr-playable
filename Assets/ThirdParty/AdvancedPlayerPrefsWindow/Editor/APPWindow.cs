...
namespace RejectedGames
{
	public class APPWindow : EditorWindow
	{
		...
		{
			string path = System.Environment.GetFolderPath(System.Environment.SpecialFolder.Personal) + "/.config/unity3d/" + PlayerSettings.companyName + "/" + PlayerSettings.productName + "/prefs";
		...
		private bool IsUnityWritingToPlist()
		{
			...
			if (Application.platform == RuntimePlatform.OSXEditor)
			{
				...
				FileInfo plistFile = new FileInfo(System.Environment.GetFolderPath(System.Environment.SpecialFolder.Personal) + "/Library/Preferences/unity." + PlayerSettings.companyName + "." + PlayerSettings.productName + ".plist");
				DirectoryInfo di = new DirectoryInfo(System.Environment.GetFolderPath(System.Environment.SpecialFolder.Personal) + "/Library/Preferences/");
