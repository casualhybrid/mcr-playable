    ...
    public class ComboBox : MonoBehaviour
    {
        ...
        private bool Initialize()
        {
            ...
            catch (System.NullReferenceException ex)
            {
                ...
                UnityEngine.Console.LogError("Something is setup incorrectly with the dropdownlist component causing a Null Reference Exception");
                success = false;
            }
        ...
        */
        ...
        {
            //UnityEngine.Console.Log("item " + item + " clicked");
            Text = item;
        ...
        public void OnValueChanged(string currText)
        {
            Text = currText;
            RedrawPanel();
            //UnityEngine.Console.Log("value changed to: " + currText);
