...
namespace deVoid.UIFramework.Editor
{
    ...
    {
        private const string UIPrefabFolder = "Assets/UIManagement/Prefabs/Screens";
        private const string UIIdScriptFolder = "Assets/UIManagement/Scripts";
        private const string ScreenIdScriptName = "ScreenIds";
        private const string ScreenIdScriptNamespace = "Knights.UISystem";
