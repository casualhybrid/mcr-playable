    ...
    public class UI_InfiniteScroll : MonoBehaviour
    {
        ...
        public void Init()
        {
            if (GetComponent<ScrollRect>() != null)
            {
                ...
                {
                    UnityEngine.Console.LogError("UI_InfiniteScroll doesn't support scrolling in both directions, please choose one direction (horizontal or vertical)");
                }
            ...
            {
                UnityEngine.Console.LogError("UI_InfiniteScroll => No ScrollRect component found");
            }
        }
