                ...
                for (int i = 0; i < _keys.Count; i++)
                {
                    ...
                    if (_keys[i] == null)
                    {
                        ...
                        if (typeof(Object).IsAssignableFrom(typeof(TKey)))
                        {
                            ...
                            {
                                UnityEngine.Console.LogError("A key of type: " + tKeyType + " requires to have a valid RequiredReferences reference");
                                continue;
                            }
                            ...
                            if (_keys[i] == null)
                            {
                                UnityEngine.Console.LogError("Couldn't find " + tKeyType + " reference.");
                                continue;
                            }
                        }
                        else
