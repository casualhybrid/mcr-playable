...
[CreateAssetMenu(fileName = "MenuDiamondsADSO", menuName = "ScriptableObjects/Ads/RewardedAds/MenuDiamondsADSO")]
public class MenuDiamondsADSO : RewardedAdSO
{
    ...
    public override void CompletionCallBack(Status status, ADMeta adMeta)
    {
        ...
        inventorySystem.UpdateKeyValues(new List<InventoryItem<int>> { new InventoryItem<int>("AccountDiamonds", 5, true) }, true, true, "DiamondsRewarded_Menu");
