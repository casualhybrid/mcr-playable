...
namespace UnityEngine.UI.Extensions
{
	...
	public class UISelectableExtension : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
	{
		...
		public void TestClicked()
		{
				...
				UnityEngine.Console.Log("Control Clicked");
			#endif
		}
		...
		{
			#if DEBUG || UNITY_EDITOR
				UnityEngine.Console.Log("Control Pressed");
			#endif
		}
		...
		{
			#if DEBUG || UNITY_EDITOR
				UnityEngine.Console.Log("Control Released");
			#endif
		}
		...
		{
			#if DEBUG || UNITY_EDITOR
				UnityEngine.Console.Log("Control Held");
			#endif
		}
