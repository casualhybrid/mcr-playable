...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableList : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            {
                UnityEngine.Console.LogError("You need to have a child LayoutGroup content set for the list: " + name, gameObject);
                return;
            }
            ...
            {
                UnityEngine.Console.LogError("You need to have a Graphic control (such as an Image) for the list [" + name + "] to be droppable", gameObject);
                return;
            }
        ...
        {
            UnityEngine.Console.Log("Event Received");
            UnityEngine.Console.Log("Hello World, is my item a clone? [" + item.IsAClone + "]");
        }
