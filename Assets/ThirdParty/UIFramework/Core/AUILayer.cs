...
namespace deVoid.UIFramework
{
    ...
    public abstract class AUILayer<TScreen> : MonoBehaviour where TScreen : IUIScreenController
    {
        ...
        public void RegisterScreen(string screenId, TScreen controller)
        {
            ...
            {
                UnityEngine.Console.LogError("[AUILayerController] Screen controller already registered for id: " + screenId);
            }
        }
        ...
        public void UnregisterScreen(string screenId, TScreen controller)
        {
            ...
            {
                UnityEngine.Console.LogError("[AUILayerController] Screen controller not registered for id: " + screenId);
            }
        }
        ...
        public void ShowScreenById(string screenId)
        {
            ...
            {
                UnityEngine.Console.LogError("[AUILayerController] Screen ID " + screenId + " not registered to this layer!");
            }
        }

        ///// <summary>
        ///// Whether the screen is registered to this particular layer
        ///// </summary>
        ///// <param name="screenID">The ID Of the screen to check</param>
        //public bool IsTheScreenRegistered(string screenID)
        //{
        ...
        public void ShowScreenById<TProps>(string screenId, TProps properties) where TProps : IScreenProperties
        {
            ...
            {
                UnityEngine.Console.LogError("[AUILayerController] Screen ID " + screenId + " not registered!");
            }
        }
        ...
        public void HideScreenById(string screenId)
        {
            ...
            {
               // UnityEngine.Console.LogError("[AUILayerController] Could not hide Screen ID " + screenId + " as it is not registered to this layer!");
            }
        }


        public virtual void EnableScreen(string screenId) 
        {
            TScreen ctl;
            if (registeredScreens.TryGetValue(screenId, out ctl))
            {
        ...
        public virtual void DisableScreen(string screenId)
        {
            TScreen ctl;
            if (registeredScreens.TryGetValue(screenId, out ctl))
            {
                DisableTheScreen(ctl);
            }
            else
            {
                UnityEngine.Console.LogError("[AUILayerController] Could not hide Screen ID " + screenId + " as it is not registered to this layer!");
        ...
        protected virtual void EnableTheScreen(TScreen screen)
        {

        }

        protected virtual void DisableTheScreen(TScreen screen)
        {
