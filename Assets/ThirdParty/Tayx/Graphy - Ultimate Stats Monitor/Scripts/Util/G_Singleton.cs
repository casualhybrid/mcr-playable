    ...
    public class G_Singleton<T> : MonoBehaviour where T : MonoBehaviour
    {
        ...
        public static T Instance
        {
            get
            {
                ...
                {
                    //UnityEngine.Console.LogWarning("[Singleton] Instance '" + typeof(T) +
                ...
                lock (_lock)
                {
                    if (_instance == null)
                    {
                        ...
                        {
                            //UnityEngine.Console.LogError("[Singleton] Something went really wrong " +
                        ...
                        if (_instance == null)
                        {
                            ...
                            //UnityEngine.Console.Log("[Singleton] An instance of " + typeof(T) +
                            //    " is needed in the scene, so '" + singleton +
                            //    "' was created with DontDestroyOnLoad.");

                            UnityEngine.Console.Log
                            (
                        ...
                        {
                            //UnityEngine.Console.Log("[Singleton] Using instance already created: " +
