...
namespace deVoid.UIFramework
{
    ...
    public class WindowUILayer : AUILayer<IWindowController>
    {
        ...
        protected override void EnableTheScreen(IWindowController screen)
        {
            base.EnableTheScreen(screen);

            AWindowController controller = screen as AWindowController;
            controller.gameObject.SetActive(true);
        }


        protected override void DisableTheScreen(IWindowController screen)
        {
            base.DisableTheScreen(screen);
