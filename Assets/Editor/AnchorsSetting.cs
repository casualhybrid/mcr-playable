using UnityEditor;
using UnityEngine;
public class AnchorsSetting : EditorWindow
{
    public GameObject Adsprefab;

    //[MenuItem("Anchors/Delete All Player Preferences")]
    ...
    [MenuItem("Anchors/Anchors/Set Anchors to Corners for Selected GameObject #Z")]
    ...
    [MenuItem("Anchors/Anchors/Set Anchors to Corners for Selected GameObjects #X")]
    ...
    [MenuItem("Anchors/Anchors/Set Anchors to Corners for Whole Canvas % & C")]
    ...
    ////Cheats
    //[MenuItem("Hoho/Cheats/Unlock All Characters")]
    //static void UnlockAllCharacters()
    //{
    //    PlayerPrefs.SetInt("UnlockAllCharacters", 1);
    //}

    //[MenuItem("Hoho/Cheats/Unlock All Levels")]
