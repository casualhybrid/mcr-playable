...
#pragma warning restore CS0649
	...
	void CreateMaterialIfNeeded()
	{
		...
		{
			UnityEngine.Console.LogError( "FXAA is not supported on this device." );
			enabled = false;
			return;
		}
	}
	...
	public RenderTexture DoFXAA( RenderTexture source)
	{
        ...
        RenderTexture ResultingTexture = RenderTexture.GetTemporary(source.width, source.height, source.depth, source.format);

        Graphics.Blit( source, ResultingTexture, mat );
